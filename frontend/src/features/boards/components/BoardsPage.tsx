...
import { LogOut, Pencil, PenLine, Plus, Trash2 } from 'lucide-react'
...
export function BoardsPage() {
  ...
  async function handleCreateBoard() {
    ...
    try {
      ...
      navigate(`/board/${board.room_id}`, { state: { name: board.name, boardId: board.id } })
    } catch (err) {
    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-xl font-semibold text-neutral-900">Your boards</h1>
          <button
                  ...
                  <button
                    onClick={() =>
                      navigate(`/board/${board.room_id}`, {
                        state: { name: board.name, boardId: board.id },
                      })
                    }
